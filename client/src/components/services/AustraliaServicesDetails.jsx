...
const AustraliaServicesDetails = () => {
                ...
                <div className="container pt-2 mb-4 individula__container">
                    ...
                    <div className="row pt-2 mb-2">
                        <div className="clearfix">
                            ...
                            <p className="txt__desc txt_justify">{AusServicesDetails.ht_title_desc}</p>
                            <p className="txt__desc txt_justify">{AusServicesDetails.ht_title_desc1}</p>
                            <p className="txt__desc txt_justify">{AusServicesDetails.ht_title_desc2}</p>
                            <p className="txt__desc txt_justify">{AusServicesDetails.ht_title_desc3}</p>
                            ...
                            {AusServicesDetails.content12 !== undefined && AusServicesDetails.content12.map((item) => {
                                return (
                                    <div className="" key={item.id}>
                                        <h6 className="txt__idividual">{item.subtitle12}</h6>
                                        <h6 className="txt__idividual__sub">{item.ht_content1}</h6>
                                        ...
                                        <ul>
                                            ...
                                            {item.desc5 && <li className="txt__desc txt_justify">{item.desc5}</li>}
                                            {item.desc6 && <li className="txt__desc txt_justify">{item.desc6}</li>}
                                            {item.desc7 && <li className="txt__desc txt_justify">{item.desc7}</li>}
                                            {item.desc8 && <li className="txt__desc txt_justify">{item.desc8}</li>}
                                            {item.desc9 && <li className="txt__desc txt_justify">{item.desc9}</li>}
                                            ...
                                            <li className="txt__desc txt_justify">{item.desc5}</li>
                                            <li className="txt__desc txt_justify">{item.desc6}</li>
                                            <li className="txt__desc txt_justify">{item.desc7}</li>
                                            <li className="txt__desc txt_justify">{item.desc8}</li>
                                            <li className="txt__desc txt_justify">{item.desc9}</li>
                                            <li className="txt__desc txt_justify">{item.desc10}</li> */}
                                        </ul>
                                    </div>
                                )
                            })}
                            {AusServicesDetails.content_local_ef !== undefined && AusServicesDetails.content_local_ef.map((item) => {
                                return (
                                    <div className="" key={item.id}>
                                        <h6 className="txt__idividual">{item.subtitle1}</h6>
                                        {item.desc1 && <p className="txt__desc txt_justify">{item.desc1}</p>}
                            ...
                            {AusServicesDetails.content_international_exp !== undefined && AusServicesDetails.content_international_exp.map((item) => {
                                return (
                                    <div className="" key={item.id}>
                                        <h6 className="txt__idividual">{item.subtitle1}</h6>
                                        {item.desc1 && <p className="txt__desc txt_justify">{item.desc1}</p>}
                            ...
                            {AusServicesDetails.content_australian_market !== undefined && AusServicesDetails.content_australian_market.map((item) => {
                                return (
                                    <div className="" key={item.id}>
                                        <h6 className="txt__idividual">{item.subtitle1}</h6>
                                        {item.desc1 && <p className="txt__desc txt_justify">{item.desc1}</p>}
                            ...
                            {AusServicesDetails.content_auditing !== undefined && AusServicesDetails.content_auditing.map((item) => {
                                return (
                                    <div className="" key={item.id}>
                                        <h6 className="txt__idividual__sub">{item.ht_content1}</h6>
                                        {item.desc1 && <p className="txt__desc txt_justify">{item.desc1}</p>}
...
export default AustraliaServicesDetails;