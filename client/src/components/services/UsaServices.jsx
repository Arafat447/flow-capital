...
import services_Chicago from "../../assets/services_Chicago.jpg";
...
const UsaServices = () => {
    const [servicesData, setServicesData] = useState([
        {
            id: 1,
            banner_imgs: inividual_tax_banner,
        ...
        },
        {
            ...
            ht_title: "ENTITY SETUP FOR LOCALS",
        ...
        },
        {
            ...
            ht_title: "ENTITY SETUP FOR FOREIGNERS",
        ...
        <>
            {/* <section className="pb-4">
                <div className="banner__about">
                    <img src={services_Chicago} className="img-fluid"  alt="image" border="0" />
                </div>
            </section> */}
            ...
            <section>
                ...
                <div className="banner__about">
                    ...
                    <h3 className="txt__title text-center mt-4">USA SERVICES</h3>
                    <div className="row pt-2">
                        <div className="col-12">
                            <p className="txt__desc txt_justify">
                                Shelley Global Inc offers a wide range of tax and financial services in the United States to individuals, businesses, and trusts.
                                These services include the preparation of federal and state tax returns for individuals, partnerships, corporations, and estates
                                and trusts. In addition, the company provides international tax preparation services for both individuals and businesses, as well
                                as assistance with entity setup for both US residents and foreigners. Other services include bookkeeping and payroll, reporting,
                                and advisory services related to taxation and financial planning. Shelley Global Inc aims to help clients navigate the complex
                                tax system in the US, minimize tax liabilities, and achieve their financial goals.
                            </p>
                        </div>
                    </div>
                    <div className="row g-3 d-flex justify-content-center">
                        {
                            servicesData !== undefined && servicesData.map((services) => {
                                return (
                                    <div className="col-md-4" key={services.id}>
                                        <Link to={`/usa-services/${services.id}`} className="services__list__link" rel="bookmark" title={services.ht_title}>
